...
INGPATH = raw_input("file path for list of cross sections file please:")
...
ONEDRESULTSPATH = raw_input("FOLDER path for ISIS Flow and Head results please:")
...
cols = ['id','NodePointName','ModelledFloodGroupCode','ReturnPeriod','LevelValue','Flowvalue','Supporting','deleted','Downloaded','changed','for_upload']

NFCDDtable = pd.DataFrame(columns=cols)
...
NPMTable.to_csv(path_or_buf=ONEDRESULTSPATH+'\\NPM\\'+MFGC+'.csv', sep=',')